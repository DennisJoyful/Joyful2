// components/forms/ManagerApplyForm.tsx
'use client';
...
export default function ManagerApplyForm({ managerSlug }: { managerSlug: string }) {
  // Core fields
  ...
  async function submit(){
    ...
    try {
      ...
      const res = await fetch('/api/apply/manager', { method:'POST', headers:{'content-type':'application/json'}, body });
