...
export default function WerberManager(){
  ...
  async function create(){
    ...
    const passcode = newPin.trim() || undefined;
    const payloads: any[] = [
      { slug, passcode, name: newName || undefined },
      { code: slug, passcode, name: newName || undefined },
      { slug, code: slug, passcode, name: newName || undefined },
      { slug },
      { code: slug },
    ];
    const endpoints = [
